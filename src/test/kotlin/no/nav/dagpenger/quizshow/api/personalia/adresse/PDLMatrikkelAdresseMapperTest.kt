package no.nav.dagpenger.quizshow.api.personalia.adresse

import no.nav.dagpenger.pdl.adresse.AdresseMetadata
import no.nav.dagpenger.pdl.adresse.PDLAdresse
import no.nav.dagpenger.quizshow.api.personalia.Adresse
import no.nav.dagpenger.quizshow.api.personalia.PDLAdresseMapper
