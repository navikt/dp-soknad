package no.nav.dagpenger.søknad.serder
...
import no.nav.dagpenger.søknad.AktivitetsloggVisitor
...
class AktivitetsloggMapper(aktivitetslogg: Aktivitetslogg) {
    ...
    companion object {
        ...
        fun InputStream.aktivitetslogg(): PersonData.AktivitetsloggData = jacksonJsonAdapter.readValue(this, PersonData.AktivitetsloggData::class.java)
    }
